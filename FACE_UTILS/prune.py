...
class SparsePruner(object):
    ...
    def __init__(self, model, masks, args, begin_prune_step, end_prune_step, inference_dataset_idx):
        ...
        # print(valid_key)                                                                                      ## TODO HERE
        # self.current_dataset_idx = max(len(self.model.module.datasets) - 1, self.masks[valid_key].max())      ## TODO HERE
        # print('==>', self.current_dataset_idx, len(self.model.module.datasets), self.masks[valid_key].max())  ## TODO HERE
