# -*- coding: utf-8 -*-
# the source code is modified from official facenet github
import os
import operator
import numpy as np
...
def distance(embeddings1, embeddings2, distance_metric=0):
    if distance_metric==0:
        ...
        similarity = dot / norm
        dist = np.arccos(np.clip(similarity,0,1))*4 / math.pi # notice!!!
        # np.arccos(similarity) return the value in range between [0,pi]
        # similarity must be between [-1.0,1.0]
        # https://github.com/davidsandberg/facenet/issues/692
    else:
